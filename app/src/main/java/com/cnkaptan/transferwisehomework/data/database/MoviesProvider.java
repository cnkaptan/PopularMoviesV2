...
public class MoviesProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(authority, MoviesContract.MovieEntry.PATH_MOVIES, MOVIES);
        uriMatcher.addURI(authority, MoviesContract.MovieEntry.PATH_MOVIES + "/#", MOVIE_BY_ID);

        uriMatcher.addURI(authority, MoviesContract.MovieEntry.PATH_MOVIES + "/" +
                MoviesContract.MostPopularMovies.PATH_MOST_POPULAR, MOST_POPULAR_MOVIES);
        uriMatcher.addURI(authority, MoviesContract.MovieEntry.PATH_MOVIES + "/" +
                MoviesContract.HighestRatedMovies.PATH_HIGHEST_RATED, HIGHEST_RATED_MOVIES);
        uriMatcher.addURI(authority, MoviesContract.MovieEntry.PATH_MOVIES + "/" +
                MoviesContract.MostRatedMovies.PATH_MOST_RATED, MOST_RATED_MOVIES);

        uriMatcher.addURI(authority, MoviesContract.MovieEntry.PATH_MOVIES + "/" +
                MoviesContract.Favorites.PATH_FAVORITES, FAVORITES);
